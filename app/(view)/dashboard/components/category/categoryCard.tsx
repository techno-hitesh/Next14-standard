...
<section className="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
  <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    ...
    <div className='overflow-auto flex mt-20  flex-col'>
      <h1 className='my-2 text-3xl font-bold  text-gray-700'>Shop by Category </h1>
    <div className="mb-5 flex w-[120%] h-[90%]  gap-7 ">
  {catData?.length > 0 && catData.map((catValue:any, i:any) => (
   ...
   <div className='overflow-auto flex mt-20  flex-col'>
      <h1 className='my-2 text-3xl font-bold  text-gray-700'> </h1>
    <div className="mb-5 flex w-[120%] h-[90%]  gap-7 ">
  {catData?.length > 0 && catData.map((catValue:any, i:any) => (
    <article key={i} className="relative  mt-4 w-40">
      <Link href={dashboardLinks?.subcategoryLinks + catValue._id}>
