              ...
              <div className="pointer-events-auto w-screen max-w-xl">
                ...
                <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                  ...
                  <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                      <button onClick={() => checkout()} type='submit' className="flex items-center justify-center rounded-md border w-full border-transparent custom-bg-color px-6 py-3 text-base font-medium text-white shadow-sm ">Checkout</button>
                    </div>
                  </div>
