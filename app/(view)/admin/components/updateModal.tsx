    ...
    <div className="relative left-[40%]   top-[10%] p-4 max-w-md h-full md:h-auto">
        ...
        <div className="relative p-4 bg-white text-center w-[130%] rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              ...
              <div className="w-full">
                  <label htmlFor="quna" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity</label>
                  <input type="number" min={1} name="quan" id="quan" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value={quan} onChange={(e)=>setquan(e.target.value)} placeholder="₹299" required />
              </div>
              <div>
